...
"""H = int(input("Insira o total de hot dog's consumidos no evento: "))
P = int(input("Insira o total de participantes do evento: "))

media = H / P
print("A média de consumo no evento foi de {:.2f}".format(media))"""


"""H, P = int(input("Insira o total de hot dog's consumidos no evento: "), input("A quantidade de participantes: ")).split()
